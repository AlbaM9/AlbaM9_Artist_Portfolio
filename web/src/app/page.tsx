...
const Home: React.FC<HomeProps> = () => {
  ...
  return (
    ...
    >
      ...
      <section id="gallery" className="mt-18 md:mt-24 lg:mt-32 lg:mb-32 min-w-[430px]">
        <h1 className="  text-white text-2xl md:text-4xl text-center">Jobs</h1>
        <div className="flex flex-col items-center mt-4 p-4 sm:p-6 md:p-8 lg:p-10">
          {/* Elemento Superior */}
          <div className="w-full sm:w-[20rem] md:w-[24rem] h-auto aspect-w-16 aspect-h-9 transition-transform duration-300 hover:scale-105 mb-4">
            <Banners
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-1 lg:grid-cols-2">
            {itemsForBanners.slice(1, 3).map((item) => (
              <div
                key={item.id}
                className="w-[20rem] md:w-[24rem] h-auto aspect-w-16 aspect-h-9 transition-transform duration-300 hover:scale-105 mb-4" // Agregado mb-4 para separación
              >
                <Banners
