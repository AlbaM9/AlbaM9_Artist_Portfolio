...
function AboutMe() {
    return (
        <section className="flex flex-col items-center mt-[7vh] gap-[7vh] h-screen">
            ...
            <section className="flex justify-center gap-[7vw] w-full">
                <section className="desc flex flex-col items-center justify-center w-[50vw]">
                    <p className="p-5 text-white text-lg w-[70%]">
                ...
                <section className="nameImage flex flex-col items-start text-white text-xl p-8">
                    <img
                    ...
                    />
                    <span className="text-lg font-semibold ">Alba Melchor Gómez</span>
